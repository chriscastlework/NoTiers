...
{
    public class CreateAllTestsController : ApiController
    {

        private readonly TemplateFactory<ITempalateTest> testsTemplateFactory = new TemplateFactory<ITempalateTest>();
