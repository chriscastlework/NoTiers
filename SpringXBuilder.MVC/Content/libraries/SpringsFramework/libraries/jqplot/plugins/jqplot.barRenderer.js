...
(function($) {
    ...
    $.jqplot.BarRenderer.prototype.init = function(options, plot) {
        ...
        plot.options.selectable = options.selectable;
    ...
    function postPlotDraw() {
        ...
        if (!this.options.selectable) this.eventCanvas._elem.bind('mouseleave', {plot:this}, function (ev) { unhighlight(ev.data.plot); });
    }   
    ...
    function handleMove(ev, gridpos, datapos, neighbor, plot) {
        if (neighbor) {
            ...
            if (plot.series[ins[0]].highlightMouseOver && !(ins[0] == plot.plugins.barRenderer.highlightedSeriesIndex && ins[1] == plot.series[ins[0]]._highlightedPoint)) {
                ...
                if (!plot.options.selectable) highlight (plot, neighbor.seriesIndex, neighbor.pointIndex, neighbor.points);
            }
        }
        else if (neighbor == null) {
            if (!plot.options.selectable) unhighlight (plot);
        }
    }
    ...
    function handleMouseUp(ev, gridpos, datapos, neighbor, plot) {
        ...
        plot.target.trigger(jQuery.Event('jqplotDeselectBar'));
    }
