...
({
        ...
        init: function()
        {
            ...
            this.linesLayer = this.inner.addElement(this.createElement("div",{id:"custom_layers"},["custom"]));
            ...
            this.layers = {content:this.inner};
        ...
        {
            sp.out("Orgchart getLineLayer with id:" + id);
            return;
            if(!this.layers[id])
            {
                sp.out("...no layer exists, creating new one");
                var layer = $(this.linesLayer).append(this.createElement("div"));
                $(layer).attr("id",id);
                $(layer).css("z-index",z || "");
