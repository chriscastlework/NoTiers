...
(
    {
        ...
        draw:function()
        {
            ...
            if(this.options.direction=="horizontal") $(this.getGraphic()).children().css("float","left");
            if(this.options.direction=="horizontal") $(this.getGraphic()).children().css("margin-top","inherit");
            if(this.options.direction=="horizontal") $(this.getGraphic()).children().css("margin-left","10px");
        ...
        {
            $(this.getGraphic()).find('input[type=radio][name=' + this.groupID + '][value=' + val + ']').prop('checked', true);
        },
...
(
    {
        ...
        toString:function()
        {
            return "[RadioGroupOptions, idProp:" + this.idProp + " labelProp:" + this.labelProp + " direction:" + this.direction;
        }
    }
);