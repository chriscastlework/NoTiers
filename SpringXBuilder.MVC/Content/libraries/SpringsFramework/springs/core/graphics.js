...
sp.core.graphics.create = function (pTag, pOptions)
{
    ...
    // because it's always better to have one large all-encompassing function with undocumented JSON parameters,
    // than to have specific, short functions which just do one thing.. Stanislav Bodginitisgoodenov  2016
...
sp.core.graphics.Utils =
{
    ...
    bringToFront:function(element)
    {
        ...
        $(element).css("z-index",this.getNextHighestIndex(parent));
    }
}
